...
/** Shared layout shell for bordered single-line input groups (also used by Base UI combobox root). */
export const inputGroupShellClassName =
...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return <div data-slot="input-group" role="group" className={cn(inputGroupShellClassName, className)} {...props} />;
}
