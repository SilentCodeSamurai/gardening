...
/** Portaled overlays (combobox, select, dropdown menus) live outside dialog DOM; modal dialog must not treat their clicks as outside-dismiss. */
function isTargetInsidePortaledPicker(target: EventTarget | null) {
		...
		<DialogPortal>
			...
			<DialogPrimitive.Content
				...
				onPointerDownOutside={(event) => {
					if (isTargetInsidePortaledPicker(event.detail.originalEvent.target)) {
