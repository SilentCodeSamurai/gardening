...
export type TableSelectionBulkTooltipInput = {
	...
	/** When true, selection includes built-in catalog rows that cannot be bulk-deleted from this workspace. */
...
export function tableSelectionBulkTooltip(input: TableSelectionBulkTooltipInput): string {
	...
	if (input.selectionIncludesDefaultCatalog) return m.common_bulkDeleteDisabledSelectionIncludesDefaultCatalog();
