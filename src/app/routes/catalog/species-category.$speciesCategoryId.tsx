...
export const Route = createFileRoute("/catalog/species-category/$speciesCategoryId")({
...
function SpeciesCategoryDetailPage() {
	...
	const title = translateCatalogField(data.title, data.isDefault);
					...
					<dl className="grid gap-x-4 gap-y-3 text-sm sm:grid-cols-[minmax(9rem,auto)_1fr]">
						<div className="contents">
							...
							<dd className="wrap-break-word min-w-0">
								{data.isDefault ? m.common_yes() : m.common_no()}
							</dd>
						</div>
						<div className="contents">
